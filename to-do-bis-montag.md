...
### 1) Fragebogen nur einmal ausfüllbar + sauberer Rückfall in normalen Besuchsflow - DONE
...
### 3) Regeln speichern nicht zuverlässig / Regel-Engine allgemein stabilisieren - DONE
...
### 4) Fehler beim Löschen (Fragebogen/abhängige Daten) - DONE
...
### 6) PY-Export für Fragebogen: Quartal ergänzen - Done
...
### 8) Vorverkauf: neue Einträge ohne Produktwerte -DONE
...
### 9) Vorverkauf-Export: Umsatz auf 2 Spalten aufteilen - DONE
...
### 10) KW-Handling bei Wellen: Frames eingeben statt manuell - DONE
